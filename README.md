...
so basically, use auto mode when you want to extract the SAME fields from multiple pdfs. if you want different fields from different pdfs, then use manual mode.
